...
* Оператор if Оператор if робить розгалуження програми залежно від результату перевірки деякої умови на істинність: 
    if (умова) оператор1;
Оператор if Оператор if робить рПараметр умова може бути будь-яким виразом, але найчастіше вираз містить оператори порівняння. Якщо умова, що перевіряється, має істинне значення (true), виконується оператор1. А якщо ні (false), виконання програми переходить до оператора, що йде за умовним оператором.згалуження програми залежно від результату перевірки деякої умови на істинність: if (умова) оператор1;
```c++ 
// Спосіб 1
if (b > 0){
